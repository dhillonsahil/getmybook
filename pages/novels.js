...
export default function Novels({ products }) {
  return (
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            ...
            {products.length==0 && <p>Sorry All the Novels Are Out Of Stock Right Now ! New Stock Coming Soon</p>}
            {products.map((item) => {
...
export async function getServerSideProps(context) {
  ...
  let products = await Product.find({category:'Novels'}, { createdAt: 0, updatedAt: 0, __v: 0 })
  return {
